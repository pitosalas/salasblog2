...
class TestMimeTypesRunningServer:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    assert len(response.text) == 0, (
                        f"HEAD request for {path} should not return content"
                    )
    ...
    def test_js_get_mime_type_and_content_live(self, base_url, check_server_running):
        ...
        js_paths = ["/static/js/script.js", "/static/js/main.js", "/static/script.js"]
        ...
        for path in js_paths:
            try:
                ...
                if response.status_code == 200:
                    ...
                    assert any(
                        indicator in js_content for indicator in js_indicators
