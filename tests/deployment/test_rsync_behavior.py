...
class TestRsyncUpdateBehavior:
    ...
    def test_edit_and_resync(self, temp_directories):
        ...
        create_test_post(source_dir, post_file, "Original content")
        ...
        assert edited_info["mtime"] > initial_dest_info["mtime"], (
            "Source should be newer than destination"
        )
        ...
        assert final_dest_info["content"] == edited_info["content"], (
            "Destination should have updated content"
        )
        assert "EDITED content" in final_dest_info["content"], (
    ...
    def test_destination_newer_blocks_sync(self, temp_directories):
        ...
        assert source_info["mtime"] < dest_before_info["mtime"], (
            "Source should be older than destination"
        )
        ...
        assert dest_after_info["content"] == dest_before_info["content"], (
            "Destination should be unchanged"
        )
        assert "BLOCKED" not in dest_after_info["content"], (
            "Blocked content should not appear"
        )
    ...
    def test_same_timestamp_no_copy(self, temp_directories):
        ...
        # Create and sync initial file
        create_test_post(source_dir, post_file, "Same content")
        run_rsync_update(source_dir.parent, dest_dir.parent)
    ...
    def test_multiple_files_sync(self, temp_directories):
        ...
        create_test_post(source_dir, "file1.md", "Content 1")
        create_test_post(source_dir, "file2.md", "Content 2")
        create_test_post(source_dir, "file3.md", "Content 3")
