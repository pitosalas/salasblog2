...
class TestLiveServerAdminButtons:
    ...
    def test_individual_pages_have_admin_controls_structure(
                ...
                if page_response.status_code == 200:
                    ...
                    if admin_controls:
                        ...
                        if edit_buttons:
                            ...
                            assert "/admin/edit-page/" in edit_href, (
                                "Edit link should be to admin edit page"
                            )
                        else:
                            print(f"❌ {page_link} missing edit button")

                        # Check for delete button
                        delete_buttons = page_soup.find_all(
                            "button", class_="admin-btn-delete"
                        )
                        if delete_buttons:
                            ...
                            assert "deletePage(" in delete_onclick, (
                                "Delete button should call deletePage function"
                            )
                        else:
                        ...
                        if "display: none" in admin_style:
                            ...
                            print(
                                f"⚠️  {page_link} admin controls might be visible by default"
                            )
                    else:
    ...
    def test_admin_controls_are_hidden_by_default(
        self, base_url, check_server_accessible
    ):
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if "admin-controls" in response.text:
                        ...
                        print(
                            f"ℹ️  {page_name} no admin controls found (might be expected)"
                        )
